...
namespace FlightSystem.Data.Migrations
{
    ...
    [Migration("20260326194128_Booking id as concurrency")]
    partial class Bookingidasconcurrency
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlightSystem.Data.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a19cde83-9094-4098-b357-1c7c841cd75e"),
                            Name = "USD"
                        },
                        new
                        {
                            Id = new Guid("47f985ac-cce0-4b76-aa31-2a5f7717d7df"),
                            Name = "EUR"
                        });
                });
            ...
            modelBuilder.Entity("FlightSystem.Data.Seat", b =>
                {
                    ...
                    b.HasOne("FlightSystem.Data.Segment", "Segment")
                        .WithMany("Seats")
